                                        ...
                                        <form action="submit.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-email" class=" form-control-label">Email Address <span class="text-danger">*</span></label>
                                                </div>
											...
											<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="password" id="hf-password" name="repassword" placeholder="" class="form-control" required>
											...
											<div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="file" name="appform[]"  accept=".xlsx,.xls,.doc,.docx,.pdf,.jpeg,.jpg,.png" class="form-control" required>                                           
                                                </div>
                                            </div>
											<div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-password" class=" form-control-label">Passport<span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="file" name="passport[]"  accept=".xlsx,.xls,.doc,.docx,.pdf,.jpeg,.jpg,.png" class="form-control" required>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-password" class=" form-control-label">Seaman's book<span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="file" name="sbook[]"  accept=".xlsx,.xls,.doc,.docx,.pdf,.jpeg,.jpg,.png" class="form-control" required>
                                                </div>
											...
											<div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-password" class=" form-control-label">NSO Birth Certificate</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="file" name="nso[]"  accept=".xlsx,.xls,.doc,.docx,.pdf,.jpeg,.jpg,.png" class="form-control">
											...
											<div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-password" class=" form-control-label">Marriage Contract</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="file" name="mc[]"  accept=".xlsx,.xls,.doc,.docx,.pdf,.jpeg,.jpg,.png" class="form-control">
											...
											<div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-password" class=" form-control-label">Other Documents</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="file" name="otherform[]"  accept=".xlsx,.xls,.doc,.docx,.pdf,.jpeg,.jpg,.png" class="form-control">
                                                    
                                                </div>
												
                                            </div>											
											<input type="text" value="<?php echo $_SESSION["id"]; ?>" name="encoder_id" hidden />
											<input type="text" value="2" name="privilege" hidden />
											<button type="submit" id = "submit"name="form_submit" class="btn btn-primary btn-sm">
